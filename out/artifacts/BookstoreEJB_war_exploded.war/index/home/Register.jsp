    ...
    <div layout="row" layout-align="center start">
        <div flex="30">
            <md-input-container class="md-block">
                ...
                <input ng-model="user.username" type="text" placeholder="Tên đăng nhập*" ng-required="true" autofocus>
            </md-input-container>
            ...
            <md-input-container>
                ...
                <md-select ng-model="user.nationality">
                    <md-option ng-repeat="nation in nations" value="{{nation}}">
                        {{nation}}
                    </md-option>
                </md-select>
            </md-input-container>
            ...
            <div layout="row" layout-align="center center">
                <input type="submit" class="md-button md-raised md-primary md-hue-2" href="/Register" value="Đăng ký"
                       ng-click="onSubmit()"/>
            </div>
        </div>
    </div>
